<section>
    ...
    <form enctype="multipart/form-data" method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <label class="block">
            ...
            <input type="file" onchange="handlePrev()" name="avatar" id="input-img"
                class="block w-full text-sm text-gray-300
file:mr-4 file:py-2 file:px-4
file:rounded-full file:border-0
file:text-sm file:font-semibold mb-8
file:bg-violet-50 file:text-teal-700
hover:file:bg-violet-100 " />
        </label>
        {{-- <input type="file" name="avatar" id="input-img" onchange="handlePrev()"> --}}
